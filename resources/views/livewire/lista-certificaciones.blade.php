                                ...
                                <table class="min-w-full leading-normal rounded-md">
                                    <thead>
                                        <tr>
                                            ...
                                            {{--
                                            <th class="cursor-pointer hover:font-bold hover:text-indigo-500  px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider"
                                                wire:click="order('certificacion.serie_formato')">
                                                N° Formato
                                                @if ($sort == 'certificacion.serie_formato')
                                                    @if ($direction == 'asc')
                                                        <i class="fas fa-sort-alpha-up-alt float-right mt-0.5"></i>
                                                    @else
                                                        <i class="fas fa-sort-alpha-down-alt float-right mt-0.5"></i>
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <div class="flex items-center justify-center">
                                                        @if(isset($item->Hoja->numSerie))                                                            
                                                            <p class="text-sm font-semibold  text-gray-600 p-1 bg-orange-100 rounded-full">{{ $item->Hoja->numSerie}}</p>                                                            
                                                        @else
                                                    ...
                                                    <div class="flex items-center justify-center"
                                                        ...
                                                        <div x-show="menus" x-on:click.away="menus = false" class="dropdown-content flex flex-col border bg-white shadow-xl w-48 absolute z-30 right-0 mt-60 mr-48">
                                                            <a  href="{{$item->rutaVistaCertificado}}" target="__blank" rel="noopener noreferrer"
                                                                ...
                                                                <a  href="{{$item->rutaDescargaCertificado}}" target="__blank" rel="noopener noreferrer"
                                                                class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                @else
                                                                <a  href="{{$item->rutaDescargaCertificado}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                            ...
                                                            @if($item->Servicio->tipoServicio->id==1||$item->Servicio->tipoServicio->id==10)
                                                                <a  href="{{ route('preConversionGnv',[$item->id])}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                    <i class="fas fa-eye"></i> 
                                                            ...
                                                            @endif
                                                            @if($item->Servicio->tipoServicio->id!=8)                                         
                                                                <a  href="{{$item->rutaVistaFt}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                    <i class="fas fa-eye"></i> 
                                                                    <span>Ver Ficha Tec.</span>
                                                                </a>
                                                                <a  href="{{$item->rutaDescargaFt}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                    <i class="fas fa-download"></i> 
                                                                    <span>desc. Ficha Tec.</span>
                                                                </a>
                                                                <a  href="{{ route('checkListArribaGnv',[$item->id])}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                    <i class="fas fa-eye"></i> 
                                                                    <span>CheckList Arriba</span>
                                                                </a>
                                                                <a  href="{{ route('checkListAbajoGnv',[$item->id])}}" target="__blank" rel="noopener noreferrer"
                                                                    class="focus:outline-none flex items-center space-x-4 focus:text-lime-400 text-xs w-full hover:bg-indigo-600 py-2 px-6 cursor-pointer hover:text-white">
                                                                    <i class="fas fa-eye"></i> 
