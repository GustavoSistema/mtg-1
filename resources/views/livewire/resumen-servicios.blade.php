                    ...
                    <div class="rounded-lg shadow-lg h-full block bg-white">
                        <div class="flex justify-center">
                            <div class="p-4 bg-indigo-600 rounded-full shadow-lg inline-block -mt-8">
                                <svg class="w-7 h-7 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              @switch($periodo)
                  @case(1)
                    <p class="flex text-center w-full justify-center">
                      <span class="text-white bg-indigo-300 p-1 rounded-md">DEL {{date('d-m-Y',strtotime($fecha["fechaInicio"]))}}</span>    
                    </p>
                  @break
                  @case(2)
                    <p class="flex text-center w-full justify-center">
                      <span class="text-white bg-indigo-300 p-1 rounded-md">DEL {{date('d-m-Y',strtotime($fecha["fechaInicio"]))." AL ". date('d-m-Y',strtotime($fecha["fechaFin"]))}}</span>    
                    </p>
                  @break
                  @case(3)
                    <p class="flex text-center w-full justify-center">
