<div class="mt-8 w-full items-center">
    ...
    @if (count($recepciones))
        <div class="block m-auto pt-12 items-center justify-center w-96">
         @foreach ($recepciones as $recepcion)
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-indigo-200 dark:bg-gray-800 dark:border-gray-700">   
    ...
    @else
        <div class="flex items-center justify-center mt-56">
            <p class="font-bold text-sm text-red-500 p-8 bg-amber-400 rounded-xl">No tienes ninguna recepción de materiales pendiente</p>
        </div>
    @endif
    ...
    <x-jet-dialog-modal wire:model="open" wire:loading.attr="disabled" >
        ...
        <x-slot name="footer">
            ...
            <x-jet-button wire:click="terminar" >
                Recepcionar
            </x-jet-button>   
        </x-slot>
