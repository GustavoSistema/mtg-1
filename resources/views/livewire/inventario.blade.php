        ...
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                <div class="w-full border border-indigo-400 max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <div class="mt-4">                        
                        <div class="mx-auto w-full flex flex-row justify-between items-center">
                            <p class="mt-2 text-md text-gray-600 dark:text-gray-300">En stock:</p> <span class=" mr-2 bg-amber-200 px-1 rounded-full">{{count($materiales)}}</span>                            
                        </div>  
                        <hr> 
                        <div class="mx-auto w-full flex flex-row justify-between items-center">
                            <p class="mt-2 text-md text-gray-600 dark:text-gray-300">Consumido:</p> <span class=" mr-2 bg-indigo-200 px-1 rounded-full">10</span>                            
                        </div>  
                        <hr> 
                        <div class="mx-auto w-full flex flex-row justify-between items-center">
                            <p class="mt-2 text-md text-gray-600 dark:text-gray-300">Anulado:</p> <span class=" mr-2 bg-indigo-200 px-1 rounded-full">10</span>                            
                        </div>  
                        <hr> 
                        <div class="mx-auto w-full flex flex-row justify-between items-center">
                            <p class="mt-2 text-md text-gray-600 dark:text-gray-300">Pendiente de Cambio:</p> <span class=" mr-2 bg-indigo-200 px-1 rounded-full">10</span>                            
                        </div>  
                        <hr>        
                    </div>
                ...
                <div class="border border-indigo-400 w-full max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-light text-gray-800 dark:text-gray-400">FORMATOS GLP</span>
                        <span class="px-3 py-1 text-xs text-green-800 uppercase bg-green-200 rounded-full dark:bg-blue-300 dark:text-blue-900">psychology</span>
                    </div>
