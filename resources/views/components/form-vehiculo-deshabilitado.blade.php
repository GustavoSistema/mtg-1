    ...
    <div class="mt-2 mb-6 px-8 py-2">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div>
                ...
                <x-jet-input type="text" class="w-full" wire:model="placa" maxlength="6" disabled/>
            ...
            <div>
                ...
                <x-jet-input type="text" class="w-full" wire:model="marca" disabled/>
                <x-jet-input-error for="marca" />
            </div>

            <div>
                <x-jet-label value="Modelo:" />
                <x-jet-input type="text" class="w-full" wire:model="modelo" disabled/>
                <x-jet-input-error for="modelo" />
            </div>
            <div>
                <x-jet-label value="Version:" />
                <x-jet-input type="text" class="w-full" wire:model="version" disabled/>
                <x-jet-input-error for="version" />
            </div>
            <div>
                <x-jet-label value="año de fabricación:" />
                <x-jet-input type="text" class="w-full" wire:model="anioFab" type="number" disabled/>
                <x-jet-input-error for="anioFab" />
            </div>

            <div>
                <x-jet-label value="VIN / N° Serie:" />
                <x-jet-input type="text" class="w-full" wire:model="numSerie" disabled/>
                <x-jet-input-error for="numSerie" />
            </div>
            <div>
                <x-jet-label value="N° Serie Motor:" />
                <x-jet-input type="text" class="w-full" wire:model="numMotor" disabled/>
                <x-jet-input-error for="numMotor" />
            </div>
            <div class="flex flex-row justify-center">
                <div class="w-1/2">
                    <x-jet-label value="Cilindros:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="cilindros" type="number" disabled/>
                    <x-jet-input-error for="cilindros" />
                </div>
                <div class="w-1/2">
                    <x-jet-label value="Cilindrada:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="cilindrada" type="number" disabled/>
                    <x-jet-input-error for="cilindrada" />
                </div>
            </div>
            <div>
                <x-jet-label value="Combustible:" />
                <x-jet-input type="text" class="w-full" wire:model="combustible" disabled/>
                <x-jet-input-error for="combustible" />
            </div>
            <div class="flex flex-row">
                <div class="w-1/2">
                    <x-jet-label value="Ejes:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="ejes" type="number" disabled/>
                    <x-jet-input-error for="ejes" />
                </div>
                <div class="w-1/2">
                    <x-jet-label value="Ruedas:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="ruedas" type="number" disabled/>
            ...
            <div class="flex flex-row">
                <div class="w-1/2">
                    ...
                    <x-jet-input type="text" class="w-5/6" wire:model="asientos" type="number" disabled/>
                    <x-jet-input-error for="asientos" />
                </div>
                <div class="w-1/2">
                    <x-jet-label value="Pasajeros:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="pasajeros" type="number" disabled/>
            ...
            <div class="flex flex-row w-full justify-center m-auto">
                <div class="w-1/3">
                    ...
                    <x-jet-input type="text" class="w-5/6" wire:model="largo" type="number" disabled/>
                    <x-jet-input-error for="largo" />
                </div>
                <div class="w-1/3">
                    <x-jet-label value="Ancho:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="ancho" type="number" disabled/>
                    <x-jet-input-error for="ancho" />
                </div>
                <div class="w-1/3">
                    <x-jet-label value="Altura:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="altura" type="number" disabled/>
                    <x-jet-input-error for="altura" />
                </div>
            </div>
            <div>
                <x-jet-label value="Color:" />
                <x-jet-input type="text" class="w-full" wire:model="color" disabled/>
                <x-jet-input-error for="color" />
            </div>
            <div class="flex flex-row w-full justify-center m-auto">
                <div class="w-1/3">
                    <x-jet-label value="Peso Neto:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="pesoNeto" type="number" disabled/>
                    <x-jet-input-error for="pesoNeto" />
                </div>
                <div class="w-1/3">
                    <x-jet-label value="Peso Bruto:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="pesoBruto" type="number" disabled/>
                    <x-jet-input-error for="pesoBruto" />
                </div>
                <div class="w-1/3">
                    <x-jet-label value="Carga Util:" />
                    <x-jet-input type="text" class="w-5/6" wire:model="cargaUtil" type="number" disabled/>
